                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            ?>
                            <h1>Chercher dans la BDD...</h1>
                            <br>
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a style="width:100%" class="nav-item nav-link <?php if ((empty($_GET['sites'])  and empty($_GET['collabes']) and empty($_GET['alternants']) and empty($_GET['offres']) and empty($_GET['demandes']) and empty($_GET['contacts']) and empty($_GET['entretiens']) and empty($_GET['events'])) or !empty($_GET['etablissements'])) echo "active" ?>" id="nav-home-tab1" data-toggle="tab" href="#nav-home1" role="tab" aria-controls="nav-home1" aria-selected="true">Les établissements</a>
                                    <a class="nav-item nav-link <?php if (!empty($_GET['sites'])) echo "active" ?>" id="nav-home-tab2" data-toggle="tab" href="#nav-home2" role="tab" aria-controls="nav-home2" aria-selected="false">Les sites secondaires</a>
                                    <a class="nav-item nav-link <?php if (!empty($_GET['collabes'])) echo 'active' ?>" id="nav-profile-tab2" data-toggle="tab" href="#nav-profile2" role="tab" aria-controls="nav-profile2" aria-selected="false">Les collabs CFA</a>
                                ...
                                <div class="text-nowrap tab-pane fade <?php if ((empty($_GET['sites']) and empty($_GET['collabes']) and empty($_GET['alternants']) and empty($_GET['offres']) and empty($_GET['demandes']) and empty($_GET['contacts']) and empty($_GET['entretiens']) and empty($_GET['events'])) or !empty($_GET['etablissements'])) echo "show active" ?>" id="nav-home1" role="tabpanel" aria-labelledby="nav-home-tab1">
                                        ...
                                        <thead>
                                            ...
                                            <div class="margin_bottom20">
                                                <form method="GET" enctype="multipart/form-data">
                                                    <input type="hidden" name="etablissements" value="1">
                                    ...
                                    <?php
                                                    ...
                                                    foreach ($lesUsers as $unUser) {
                                                        ...
                                                        echo ("<td><a href='fiche_etablissement?id=$id'>$nom</a></td>
                                            <td>$departement</td>
                                            <td>$ville</td>
                                            <td>$tel</td>
